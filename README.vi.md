...
*Tài liệu phiên bản 1.0.5 — đồng bộ với codebase `tmv-hrm` / `tmv-hrm-be`. Cập nhật lần cuối: 2026-07-22 (quyền leave managed, phân trang Theo dõi chấm công, import Mã NV upsert, duyệt phép hàng loạt, bulk manual inclusion).*
