...
同一分内に複数回（顔・カード・指紋など）打刻しても **1 件** として保持します。詳細は [技術付録](../appendix/technical-reference.md)。
...
- **同一ベトナム暦の分**内の複数打刻（同一ユーザー・同一端末）は UI/勤怠用に **1 件** に集約。詳細: [技術付録](../appendix/technical-reference.md)。
